	...
	return (
		...
		>
					...
					listMenu.map((values) => {
						return (
							<li
								...
								className={`mb-[40px] ${
									idMenuClicked === values.id ? 'text-[#36C1FF]' : ''
			...
			<div className='flex justify-center mt-[151px] items-center '>
				<button className='w-full bg-header cursor-pointer max-w-[310px] font-[600] text-[16px] leading-[24px] text-center text-white h-[47px] rounded-[40px] px-[22px] py-[12px] '>
					Launch App
				</button>
			</div>
		</section>
